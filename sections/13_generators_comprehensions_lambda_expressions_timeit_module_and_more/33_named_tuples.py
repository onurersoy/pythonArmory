# When dealing with data in tuples, you can make the code more readable by using named tuples.
# Named tuple instances do not have per-instance dictionaries, so they are lightweight and require no more memory than
# regular tuples.
