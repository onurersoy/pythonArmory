# For our first practical example of reading binary data, we're going to read a bitmap image, and invert it.

import os

# Binary vs text files:
# Working with binary files involves the same steps as we've been using for text files. You open the file, for reading,
# for writing, or both. When you're done, you have to close the file. You can do that explicitly, or use a 'with'
# block so that Python closes the file for you.
