...
with (open('OlympicMedals_2020.csv', encoding='utf-8', newline='') as data,\
    ...
    # '\' Notice the line continuation character – the backslash – at the end of line 6.
    # You can include as many "open file names as" clauses as you need. Each file will be opened in the mode you
    # specify, and closed automatically when the with block terminates.
